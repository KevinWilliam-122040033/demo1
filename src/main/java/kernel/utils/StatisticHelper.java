 ...
 * statistic tool provides all details of DB queries, and return to the main program with DATA
 * @author ShiJiahuan
...
public class StatisticHelper {
    ...
    /**
     * 对条形图所需要的数据进行获取。
     * obtain the data for generating bar plot
     */
